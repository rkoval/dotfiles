...
call dein#add('autozimu/LanguageClient-neovim', {
  \ 'rev': 'next',
  \ 'build': 'bash install.sh && npm install -g javascript-typescript-langserver dockerfile-language-server-nodejs bash-language-server vscode-css-languageserver-bin',
